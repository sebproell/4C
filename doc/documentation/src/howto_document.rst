...
- **Files for Download** should be included in the ``doc/documentation/src/assets`` directory.
  Within the text, you may use the sphinx ``:download:`` role, as shown :download:`here <figures/testfile.pdf>`.
  This link has been created by ``:download:`here <figures/testfile.pdf>```.
